...
if (isset($_POST['edit_id'])) {
    ...
    $query_edit = "SELECT * FROM cms_category WHERE id = :id LIMIT 0,1";
...
if (isset($_POST['submit'])) {
    ...
    if (empty($name)) {
        ...
        $query = "UPDATE cms_category SET name = :name WHERE id = :id";
        ...
        if ($stmt->execute()) {
            ...
            $msg_class = 'success';
            header("location:$root_url/login/dashboard/categories.php");
        } else {
